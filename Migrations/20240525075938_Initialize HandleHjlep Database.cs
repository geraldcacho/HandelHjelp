...
namespace HandleHjelp.Migrations
{
    /// <inheritdoc />
    public partial class InitializeHandleHjlepDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BAFC7043873", x => x.OrderID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderTypeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderTyp__23AC266CFE6FD8C6", x => x.OrderTypeId);
                });
